...
func DeleteTechnicalService(db *gorm.DB, id uint, userID *uint) error {
	var tech models.TechnicalService
	...
	if err := db.Model(&tech).Updates(models.TechnicalService{DeletedBy: userID}).Error; err != nil {
